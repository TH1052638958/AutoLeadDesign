...
openai.api_key = 'sk-LFKld8Q82VEkiT8001822d91313a4a96837aE17554BeBeD9'
...
# print(data)
pd.DataFrame({'gen_smiles':gen_list,'parent_smiles':par_list}).to_csv(parent_file_path,index=False)
